...
async def arbic(_, query: CallbackQuery):
    ...
    await query.edit_message_text(
        f""" ©♟️**[مرحبا بك] [{query.message.chat.first_name}](tg://user?id={query.message.chat.id}) ! \n
...
※ استخدم الازرار لمعرفه الاوامر المستخدمه. """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("ᠻꫀꫀ𝘳3ꪮꪮꪀ ‌ 𝚂𝙾𝚄𝚁𝙲𝙴 ♟️", url=f"https://t.me/FEER3OON"),
...
InlineKeyboardButton("لتفعيل كيبورد الاعضاء", callback_data="afyona"),
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "‹ اضف البوت لمجموعتك ›", url=f"https://t.me/FEER3OONBot?startgroup=true"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "‹ الدعم ›", url="https://t.me/FEER3OON"
                    )
                ],
            ]
        ),
...
InlineKeyboardButton(" member keyboard ", callback_data="Q_XUQ"),
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "‹ المطور ›", url=f"https://t.me/W_9_9_9"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
\n√ **في حال واجهت اي مشكلة اخرى يمكنك التواصل مع المطور من هنا : @W_9_9_9 **
\n __ Developer """,
        reply_markup=InlineKeyboardMarkup(
