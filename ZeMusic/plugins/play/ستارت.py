...
※ [انا بوت تشغيل الأغاني والفيديو  في المكالمه المرئية](https://t.me/FEER3OON) \n
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/FEER3OON) /ZE \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/FEER3OON)\n [ᠻꫀꫀ𝘳3ꪮꪮꪀ ‌ 𝚂𝙾𝚄𝚁𝙲𝙴 ♟️](https://t.me/FEER3OON)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/FEER3OON) """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("الدعم والتواصل", url=f"https://t.me/FEER3OON"),
...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/FEER3OON) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/FEER3OON) \n ※[These Features AI Based](https://t.me/FEER3OON)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
InlineKeyboardButton(" member keyboard ", callback_data="FEER3OON"),
                ],
                [                
                    InlineKeyboardButton(" Commands", callback_data="cbcmds"),
                    InlineKeyboardButton(" Donate", url=f"https://t.me/FEER3OON"),
                ],
                [
                    InlineKeyboardButton(
                        " DEVELOPER ", url="https://t.me/W_9_9_9"
                    )
                ],
            ]
        ),
...
@Client.on_callback_query(filters.regex("FEER3OON"))
async def cbguides(_, query: CallbackQuery):
    await query.answer("user guide")
    await query.edit_message_text(
        f"""🔱 **※Welcome \n
...
√ __Powered by ᠻꫀꫀ𝘳3ꪮꪮꪀ ‌ 𝚂𝙾𝚄𝚁𝙲𝙴 ♟️ """,
        reply_markup=InlineKeyboardMarkup(
            [
                [
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل مع زد إي من هن : @FEER3OON **
\n __ Developer """,
        reply_markup=InlineKeyboardMarkup(
