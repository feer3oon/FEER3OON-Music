...
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس فرعون ميوزك\n
⩹━★⊷⌯⌞ ᠻꫀꫀ𝘳3ꪮꪮꪀ ‌ 𝚂𝙾𝚄𝚁𝙲𝙴 ♟️ ⌝⌯⊶★━⩺

★قايمه مميزات سورس فرعون
            ...
            [
                [
                    InlineKeyboardButton(
                        "★⌞ ᠻꫀꫀ𝘳3ꪮꪮꪀ ‌ 𝚂𝙾𝚄𝚁𝙲𝙴 ♟️ ⌝ ©️", url=f"https://t.me/FEER3OON"),                        
                 ],[
                InlineKeyboardButton(
